      ...
      <div className="p-5 space-y-4">
        ...
        {plan.plan?.length > 0 && (
          <div className="space-y-2">
            ...
            {plan.plan.map((day, i) => (
              <div key={i}
                className={`rounded-xl border p-3.5 ${DAY_COLORS[i % DAY_COLORS.length]}`}>
                ...
                <p className="text-xs text-slate-400 ml-[4.5rem] leading-relaxed">
                  {day.goal}
                </p>
                {day.why && (
                  <p className="text-xs text-slate-600 ml-[4.5rem] mt-0.5 italic">
                    {day.why}
                  </p>
                )}
              </div>
